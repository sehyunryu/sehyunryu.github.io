        ...
        <section className="hero" id="about">
          <div className="hero-copy">
            ...
            <div className="bio">
              ...
              <p>He is a <strong>Ph.D. candidate</strong> in Electrical Engineering at <strong className="university-postech">POSTECH</strong>, advised by <a href="https://ece.snu.ac.kr/research-faculty/faculty/full-time?md=view&profid=p903">Prof. Hyun Jong Yang</a> at the <a href="https://sites.google.com/view/aislsnu/home">Advanced Intelligent Systems Lab</a>. He received his B.S. in Electrical Engineering from POSTECH in February 2023. Since January 2025, he has been an <strong>external research fellow</strong> at <strong className="university-snu">Seoul National University</strong> and an <strong>Industry-Sponsored Ph.D. Fellow</strong> at <strong className="company-samsung">Samsung Electronics</strong>. He is scheduled to join <strong className="university-stanford">Stanford University</strong> as a <strong>visiting student researcher</strong> in October 2026.</p>
            </div>
