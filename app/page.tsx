      ...
      <main>
        <section className="hero" id="about">
          <div className="hero-copy">
            ...
            <p className="subtitle">Ph.D. Candidate in Electrical Engineering at POSTECH</p>
            <div className="bio">
              <p>Sehyun is a systems engineer who designs communication as infrastructure for scalable machine intelligence. His work spans AI-native wireless systems, adaptive communication in dynamic channel environments, and communication infrastructure for machine intelligence and physical AI systems.</p>
              <p>He is advised by <a href="https://ece.snu.ac.kr/research-faculty/faculty/full-time?md=view&profid=p903">Prof. Hyun Jong Yang</a> at the <a href="https://sites.google.com/view/aislsnu/home">Advanced Intelligent Systems Lab</a>. He received his B.S. in Electrical Engineering from POSTECH in February 2023. Since January 2025, he has been an external research fellow at Seoul National University and an Industry-Sponsored Ph.D. Fellow at Samsung Electronics. He is scheduled to join Stanford University as a visiting student researcher in October 2026.</p>
            </div>
            <div className="contact-row" aria-label="Contact links">
              <a href="mailto:sh.ryu@postech.ac.kr">Email</a>
              <a href="https://www.linkedin.com/in/sehyun-ryu-57b640172/">LinkedIn</a>
              <a href="https://www.overleaf.com/read/cgzkyxxqjdnm#5d2d80">CV</a>
              <a href="https://github.com/RyuSearch">GitHub</a>
            </div>
          </div>
